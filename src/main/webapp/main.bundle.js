...
*/
    ...
    /*  EL BUENO PERO QUE LO HACE MAL
        ...
        this.http.get(this.urlJenkins + this.finalURL).subscribe(
                    response => {
                     ...
                     this.http.get(data2.builds[j].url + this.finalURL).subscribe(response => {
                      ...
                      //console.log(this.brokenList);
                        ...
                        if (average <= 0.1){
                          this.stableList.push(new Job(data3.fullDisplayName, data3.result,data2.url, average));
                        } else if (average<0.8){
                          this.semistableList.push(new Job(data3.fullDisplayName, data3.result, data2.url, average));
                        }else {
            ...
            //console.log(this.semistableList);
            //console.log(this.stableList);
            }*/
                    ...
                    if (data2.builds.length == 1) {
                        ...
                        var subscription = source1.subscribe(function (x) {
                            ...
                            for (var i = 0; i < x.length; i++) {
                                ...
                                if (data_1.displayName > numberLastBuild) {
                                    idLastBuild = i;
                                    numberLastBuild = data_1.displayName;
                                }
                            ...
                            if (average <= 0.1) {
                                _this.stableList.push(new Job(data2.name, data.result, data2.url, data.url, data.displayName));
                            }
                            else if (average < 0.8) {
                                _this.semistableList.push(new Job(data2.name, data.result, data2.url, data.url, data.displayName));
                            }
                            else {
                                _this.brokenList.push(new Job(data2.name, data.result, data2.url, data.url, data.displayName));
                            }
                        }, function (err) {
                        ...
                        var subscription = source2.subscribe(function (x) {
                            ...
                            for (var i = 0; i < x.length; i++) {
                                ...
                                if (data_2.displayName > numberLastBuild) {
                                    idLastBuild = i;
                                    numberLastBuild = data_2.displayName;
                                }
                                //console.log(data.result);
                            }
                            var average = numberOfFails / contador;
                        ...
                        var subscription = source3.subscribe(function (x) {
                            ...
                            for (var i = 0; i < x.length; i++) {
                                ...
                                if (data_3.displayName > numberLastBuild) {
                                    idLastBuild = i;
                                    numberLastBuild = data_3.displayName;
                                }
                                //console.log(data.result);
                            }
                            var average = numberOfFails / contador;
                        ...
                        var subscription = source4.subscribe(function (x) {
                            ...
                            for (var i = 0; i < x.length; i++) {
                                ...
                                if (data_4.displayName > numberLastBuild) {
                                    idLastBuild = i;
                                    numberLastBuild = data_4.displayName;
                                }
                                //console.log(data.result);
                            }
                            var average = numberOfFails / contador;
                        ...
                        var subscription = source5.subscribe(function (x) {
                            ...
                            for (var i = 0; i < x.length; i++) {
                                ...
                                if (data_5.displayName > numberLastBuild) {
                                    idLastBuild = i;
                                    numberLastBuild = data_5.displayName;
                                }
                                //console.log(data.result);
                            }
                            var average = numberOfFails / contador;
                        ...
                        var subscription = source6.subscribe(function (x) {
                            ...
                            for (var i = 0; i < x.length; i++) {
                                ...
                                if (data_6.displayName > numberLastBuild) {
                                    idLastBuild = i;
                                    numberLastBuild = data_6.displayName;
                                }
                                //console.log(data.result);
                            }
                            var average = numberOfFails / contador;
                        ...
                        var subscription = source7.subscribe(function (x) {
                            ...
                            for (var i = 0; i < x.length; i++) {
                                ...
                                if (data_7.displayName > numberLastBuild) {
                                    idLastBuild = i;
                                    numberLastBuild = data_7.displayName;
                                }
                                //console.log(data.result);
                            }
                            var average = numberOfFails / contador;
                        ...
                        var subscription = source8.subscribe(function (x) {
                            ...
                            for (var i = 0; i < x.length; i++) {
                                ...
                                if (data_8.displayName > numberLastBuild) {
                                    idLastBuild = i;
                                    numberLastBuild = data_8.displayName;
                                }
                                //console.log(data.result);
                            }
                            var average = numberOfFails / contador;
                        ...
                        var subscription = source9.subscribe(function (x) {
                            ...
                            for (var i = 0; i < x.length; i++) {
                                ...
                                if (data_9.displayName > numberLastBuild) {
                                    idLastBuild = i;
                                    numberLastBuild = data_9.displayName;
                                }
                                //console.log(data.result);
                            }
                            var average = numberOfFails / contador;
                        ...
                        var subscription = source10.subscribe(function (x) {
                            ...
                            for (var i = 0; i < x.length; i++) {
                                ...
                                if (data_10.displayName > numberLastBuild) {
                                    idLastBuild = i;
                                    numberLastBuild = data_10.displayName;
                                }
                                //console.log(data.result);
                            }
                            var average = numberOfFails / contador;
